...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Expected <Bob>, but found <Sue>.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Missing the part of the code that interprets 0 as infinite turns.
    ...
    // Defect(s) Found: Expected <Tim>, but found <Sue>.
