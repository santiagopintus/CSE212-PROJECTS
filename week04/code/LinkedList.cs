...
public class LinkedList : IEnumerable<int>
{
    ...
    {
        // If the list has only one item in it, then both head and tail should be null
        if (_tail == _head)
        {
            _head = null;
            _tail = null;
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                // If "value" is the head of the list, reuse RemoveHead
                if (curr == _head)
                {
                    RemoveHead();
                }
                // If "value" is the tail of the list, reuse RemoveTail
                else if (curr == _tail)
                {
                    RemoveTail();
                }
                // If "value" is in the middle of the list
                else
                {
    ...
    {
        var curr = _tail; // Start at the end since we want to go backwards
        while (curr is not null)
        {
